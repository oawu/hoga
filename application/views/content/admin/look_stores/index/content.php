          ...
          <tr>
            ...
            <td data-title='是否啟用' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $store->id;?>'<?php echo $store->is_enabled == LookProduct::IS_ENABLED ? ' checked' : '';?>>
                <span></span><div><?php echo LookProduct::$isIsEnabledNames[$store->is_enabled];?></div>
              </label>
            </td>
