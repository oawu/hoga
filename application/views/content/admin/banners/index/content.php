          ...
          <tr>
            ...
            <td data-title='是否啟用' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $banner->id;?>'<?php echo $banner->is_enabled == Banner::IS_ENABLED ? ' checked' : '';?>>
                <span></span><div><?php echo Banner::$isIsEnabledNames[$banner->is_enabled];?></div>
              </label>
            </td>
