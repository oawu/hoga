  ...
  <table class='table-form'>
    <tbody>
      ...
      <?php if ($tags = KawashimaStoreTag::all ()) {
              foreach ($tags as $tag) { ?>
                <option value='<?php echo $tag->id;?>'<?php echo (isset ($posts['kawashima_store_tag_id']) ? $posts['kawashima_store_tag_id'] : $store->kawashima_store_tag_id) == $tag->id ? ' selected': '';?>><?php echo $tag->name;?>(<?php echo $tag->en_name;?>)</option>
        <?php }
            } else { ?>
