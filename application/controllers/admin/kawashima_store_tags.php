...
class Kawashima_store_tags extends Admin_controller {
  private $uri_1 = null;
  private $tag = null;
  ...
  public function __construct () {
    ...
    $this->uri_1 = 'kawashima_store_tags';

    if (in_array ($this->uri->rsegments (2, 0), array ('edit', 'update', 'destroy', 'sort')))
      if (!(($id = $this->uri->rsegments (3, 0)) && ($this->tag = KawashimaStoreTag::find ('one', array ('conditions' => array ('id = ?', $id))))))
  ...
  public function index ($offset = 0) {
    ...
    $limit = 25;
    $total = KawashimaStoreTag::count (array ('conditions' => $conditions));
    ...
    $store_tags = KawashimaStoreTag::find ('all', array (
        'offset' => $offset,
        'limit' => $limit,
        'order' => 'id DESC',
  ...
  public function create () {
    ...
    $tag = null;
    $create = KawashimaStoreTag::transaction (function () use (&$tag, $posts) {
      if (!verifyCreateOrm ($tag = KawashimaStoreTag::create (array_intersect_key ($posts, KawashimaStoreTag::table ()->columns))))
        return false;
  ...
  public function update () {
    ...
    $tag = $this->tag;
    $update = KawashimaStoreTag::transaction (function () use ($tag, $posts) {
      if (!$tag->save ())
        return false;
  ...
  public function destroy () {
    $tag = $this->tag;
    $delete = KawashimaStoreTag::transaction (function () use ($tag) {
      return $tag->destroy ();
    });
