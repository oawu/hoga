...
<div id='tab'>
  <div>
    <a href="<?php echo base_url ('kawashima', 'abouts');?>" class='a'><span>品牌理念</span>．Philosophy</a>
    <a href="<?php echo base_url ('kawashima', 'abouts', 2);?>"><span>品牌故事</span>．Brand Story</a>
  </div>
</div>
...
<div class='value'>
  <div>確保我們的產品真實可靠，由傳統意大利製造業及滿懷熱忱的工人製造，質量上乘，可滿足客戶的更高要求。 我們知悉新客戶想了解更多有關所購買產品資訊的需要。 Kawashima概念工廠的產品產自意大利，這一點毫無疑問。</div>
</div>
