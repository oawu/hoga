          ...
          <tr>
            ...
            <td data-title='是否啟用' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $product->id;?>'<?php echo $product->is_enabled == LookProduct::IS_ENABLED ? ' checked' : '';?>>
                <span></span><div><?php echo LookProduct::$isIsEnabledNames[$product->is_enabled];?></div>
              </label>
            </td>
