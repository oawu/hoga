          ...
          <tr>
            ...
            <td data-title='是否啟用' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $banner->id;?>'<?php echo $banner->is_enabled == LookBanner::IS_ENABLED ? ' checked' : '';?>>
                <span></span><div><?php echo LookBanner::$isIsEnabledNames[$banner->is_enabled];?></div>
              </label>
            </td>
