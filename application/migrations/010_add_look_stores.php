...
class Migration_Add_look_stores extends CI_Migration {
  public function up () {
    $this->db->query (
      "CREATE TABLE `look_stores` (
        `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
        `user_id` int(11) unsigned NOT NULL COMMENT 'User ID',
        `look_store_tag_id` int(11) unsigned NOT NULL COMMENT 'Look Store Tag ID',
        ...
        KEY `look_store_tag_id_index` (`look_store_tag_id`),
        KEY `is_enabled_index` (`is_enabled`),
        KEY `id_is_enabled_index` (`id`, `is_enabled`),
        FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
        FOREIGN KEY (`look_store_tag_id`) REFERENCES `look_store_tags` (`id`) ON DELETE CASCADE
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;"
    );
  }
  public function down () {
    $this->db->query (
      "DROP TABLE `look_stores`;"
    );
  }
}