          ...
          <tr>
            ...
            <td data-title='是否啟用' width='90'>
              <label class='index_checkbox'>
                <input type='checkbox' data-id='<?php echo $press->id;?>'<?php echo $press->is_enabled == LookPress::IS_ENABLED ? ' checked' : '';?>>
                <span></span><div><?php echo LookPress::$isIsEnabledNames[$press->is_enabled];?></div>
              </label>
            </td>
